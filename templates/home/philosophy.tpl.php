<section id="philosophy" class="teaser-section bg-philosophy">
    <div class="container center-layout">
        ...
        <div class="metamorphosis-grid">
            <div class="step">
                <div class="icon"><img src="../img/caterpillar.png" alt="Caterpillar" loading="lazy"></div>
            ...
            <div class="step">
                <div class="icon"><img src="../img/cocoon.png" alt="Cocoon" loading="lazy"></div>
            ...
            <div class="step">
                <div class="icon"><img src="../img/butterfly.png" alt="Butterfly" loading="lazy"></div>
