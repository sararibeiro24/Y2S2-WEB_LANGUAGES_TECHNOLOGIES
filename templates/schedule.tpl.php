...
function drawClassCard($classTime, $status, $title, $trainer, $duration, $spots, $imageIcon = 'relogio.png', $usersIcon = 'follower.png', $buttonText = 'Enroll Now') {
    ...
    <article class="card class-card">
        ...
        <div class="class-meta">
            <span><img src="../img/<?php echo htmlspecialchars($imageIcon); ?>" alt="Clock icon"><?php echo htmlspecialchars($duration); ?> min</span>
            <span><img src="../img/<?php echo htmlspecialchars($usersIcon); ?>" alt="Users icon"><?php echo htmlspecialchars($spots); ?> spots</span>
        </div>
        <?php if ($isDisabled): ?>
